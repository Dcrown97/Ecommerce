...
function WishList() {
    ...
    const wishList = JSON.parse(localStorage.getItem('react-use-cart'))
    console.log(wishList);

   
       let wishL = wishList.items.filter(item => item.type == 'wish')
    //    console.log('list', wishL);
